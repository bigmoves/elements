 ...
 *   - instance: Custom quickslice instance URL (default: "https://quickslice-production-ddc3.up.railway.app")
 *
 * Example:
 *   <qs-tangled-stars handle="slices.network" repo="quickslice"></qs-tangled-stars>
 *   <qs-tangled-stars handle="alice.bsky.social" repo="myrepo" instance="https://my-quickslice.example.com"></qs-tangled-stars>
 */
...
const DEFAULT_QUICKSLICE_URL = "https://quickslice-production-ddc3.up.railway.app";
...
class TangledStars extends HTMLElement {
  ...
  get instance() {
    return this.getAttribute("instance") || DEFAULT_QUICKSLICE_URL;
  }
  ...
  async #fetchStars() {
    ...
    try {
      ...
      const res = await fetch(`${this.instance}/graphql`, {
        method: "POST",
